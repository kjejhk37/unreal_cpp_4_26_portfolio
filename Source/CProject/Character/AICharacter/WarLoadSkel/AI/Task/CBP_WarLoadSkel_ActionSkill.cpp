...
#include "Character/AICharacter/WarLoadSkel/AI/Task/CBP_WarLoadSkel_ActionSkill.h"
...
UCBP_WarLoadSkel_ActionSkill::UCBP_WarLoadSkel_ActionSkill()
{

}

EBTNodeResult::Type UCBP_WarLoadSkel_ActionSkill::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
...
void UCBP_WarLoadSkel_ActionSkill::TickTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
