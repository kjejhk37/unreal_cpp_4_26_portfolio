...
#include "Skill/Spawn_Skill/Simple/Bullet/CBP_SkillSpawn_BulletType_Skill.h"
...
ACBP_SkillSpawn_BulletType_Skill::ACBP_SkillSpawn_BulletType_Skill()
{
...
void ACBP_SkillSpawn_BulletType_Skill::Play(bool const InSuccess, bool& Success)
{
